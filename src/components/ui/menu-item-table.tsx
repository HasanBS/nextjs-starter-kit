...
type column = { name: string, uid: string, sortable: boolean };
...
const INITIAL_VISIBLE_COLUMNS = ['name', 'thumbnail', 'price', 'actions'];
...
export default function MenuItemTable() {
    ...
    const filteredItems = React.useMemo(() => {
        ...
        if (hasSearchFilter) {
            filteredMenuItems = filteredMenuItems.filter((user) => user.name.toLowerCase().includes(filterValue.toLowerCase()));
        }
